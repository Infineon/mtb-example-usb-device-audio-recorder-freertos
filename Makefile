...
#
# Setting this path overrides the default GCC_ARM toolchain directory. It is used when
# the compiler is located at a non-default directory. Make uses this variable for the
# path to the assember, compiler, linker, objcopy, and other toolchain binaries.
# 
